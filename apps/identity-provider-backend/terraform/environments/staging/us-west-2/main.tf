...
locals {
  ...
  pass_online_domain     = "passonline.cloud"
...
module "futureverse-oidc" {
  ...
  repository_id = "588179492154"
  image_tag     = var.image_tag

  # base config
  zone_name               = "futureverse.cloud"
  domain_name             = "login.futureverse.cloud"
  captcha_domain_name     = "login.futureverse.cloud"
  ...
  oidc_hostname           = "https://login.futureverse.cloud"
  sendgrid_from_email     = "verify@futureverse.cloud"
  sendgrid_template_id    = "d-78f913c0d8c7473fa9fe4e158134b745"
  foundation_api_base_url = "https://foundation.passonline.cloud"
  logger_level            = "debug"
  oidc_cdn_record_weight  = local.oidc_cdn_record_weight

  cdn_hostname = "https://cdn.passonline.cloud"

  signer_hostname = "https://signer.passonline.cloud"
  ...
  # 3rd-party idps
  google_client_id = "913547680811-shr20m6hc29v2dc7garep93kaba4gnkc.apps.googleusercontent.com"
  ...
  signer_legacy_redirect_uri = "https://signer.futureverse.cloud/api/auth/callback/fv"
  signer_redirect_uri        = "https://signer.passonline.cloud/api/auth/callback/fv"
  demo_client_id             = "demo"
  demo_redirect_uri          = "https://demo.futureverse.cloud/api/auth/callback/fv"
  dashboard_hostname         = "https://identity-dashboard.futureverse.cloud"
  dashboard_client_id        = "dashboard"
  dashboard_redirect_uri     = "https://identity-dashboard.futureverse.cloud/login,https://futureverse-identity-dashboard-*.vercel.app/login"
  ...
  # twilio
  twilio_sms_verification_service_id = "VA1b931185e6fc2fff27eb7df25b78a35f"
  ...
  xrpl_json_prc_url = "wss://s.altnet.rippletest.net:51233"
