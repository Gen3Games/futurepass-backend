...
import type { Erc20Peg, Erc20PegInterface } from '../Erc20Peg'
...
export class Erc20Peg__factory {
  static readonly abi = _abi
  static createInterface(): Erc20PegInterface {
    return new utils.Interface(_abi) as Erc20PegInterface
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Erc20Peg {
    return new Contract(address, _abi, signerOrProvider) as Erc20Peg
  }
}
