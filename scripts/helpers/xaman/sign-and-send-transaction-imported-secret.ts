...
const accountLibTest = async () => {
  const importedAccount = AccountLib.derive.familySeed(
    'sEdS4rAgVysUtD5Zmm9F8i8uJBGik4K'
  )
  ...
  // IMPORTANT: it would fail here because the public key is prefixed by ED and not a secp256k1
  // fails with `Unknown point format`
